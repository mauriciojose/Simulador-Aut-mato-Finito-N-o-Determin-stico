...
public class ControleTransicao {
    ...
    public static HashMap<String, Boolean> existe = new HashMap();
    public static HashMap<String, Boolean> existeEpslonFinal = new HashMap();
    ...
    public ArrayList<String> estadosFinaisProcesso = new ArrayList();
    
    boolean temEpslon = false;

    int percorrePalavra = 0;

    private String caracterAtual;
...
//        Estado e = new Estado("0");
        ...
        if (aceita) {
            ...
            JOptionPane.showMessageDialog(null, "Palavra INVÁLIDA f!");
        }
    ...
    public boolean percorrePalavra(Estado inicial, String palavra) {
        ...
        percorrePalavra=0;
        System.out.println("Transicao.ControleTransicao.percorrePalavra(): "+estados.size());
        ...
        while (percorrePalavra < palavra.length()) {
            ...
            if (!verificaEpslon(estados)) {
                ...
                System.out.println("substring: "+palavra.substring(percorrePalavra,percorrePalavra+1));
                setCaracterAtual(palavra.substring(percorrePalavra,percorrePalavra+1));
    ...
    public boolean verificaCaracter(String recebeCaracter, ArrayList<String> estadosAtuais) {
        ...
        for (int percorreEstados = 0; percorreEstados < estadosAtuais.size(); percorreEstados++) {
            ...
            if (map.containsKey(estadosAtuais.get(percorreEstados))) {
                ...
                for (int percorreTransicoes = 0; percorreTransicoes < TransicoesEstados.size(); percorreTransicoes++) {
                    ...
                    if (TransicoesEstados.get(percorreTransicoes).caracterTransicao.equals(recebeCaracter)) {
        ...
        for (int percorreEstadosAtuais = 0; percorreEstadosAtuais < estadosAtuais.size(); percorreEstadosAtuais++) {
            ...
            if ((map.containsKey(estadosAtuais.get(percorreEstadosAtuais))) && b == false) {
                ...
                for (int percorreTransicoes = 0; percorreTransicoes < transicoes.size(); percorreTransicoes++) {
                    ...
                    if (transicoes.get(percorreTransicoes).caracterTransicao .equals("E")) {
    ...
    public String getCaracterAtual() {
        return caracterAtual;
    }

    public void setCaracterAtual(String caracterAtual) {
